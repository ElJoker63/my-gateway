...
class GatewayChatRequest(BaseModel):
    ...
    provider: str | None = Field(default=None, max_length=64, description="LLM provider to use")
    model: str | None = Field(default=None, max_length=256, description="Model override")
...
class ProjectIndexRequest(BaseModel):
    ...
    project_name: str | None = Field(default=None, description="Project name (defaults to directory name)")
